...
<% 
      	...
      	String query = "SELECT * FROM artist_content WHERE id=?;";
		PreparedStatement ps = con.prepareStatement(query);
		ps.setInt(1, id);

      	ResultSet rs =  ps.executeQuery();
      	request.setAttribute("Arts", rs);
...
<div class="navbar art-gallery">
    ...
    <div>
        <a href="favorite_list.jsp">Favorite List</a>
        <a href="userList.jsp" class="logout-link">User</a>
    ...
    %>
                <div class="art-card">
                    ...
                    <form action="favoriteList" method="POST">
                        ...
                        <button type="submit" class="add-btn-fav">Add to Favorite</button>
                    </form>
                </div>
    <%
