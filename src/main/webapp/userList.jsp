...
<div class="container">
  <div class="table-title">
  	<div class="row">
		...
		<div class="col-md-6">
			<a href="home.jsp" class="btn btn-light ">Back to Home</a>
		</div>
	</div>
  </div>
		    ...
		    <tbody>
		        	...
		        	int idCounter = 1;// here we use idCounter to automatically count the number regardless of table id 
		            		try (Connection connection = DBUtil.getConnection()) {
		                        ...
		                        while (resultSet.next()) {
		                            int contentId = resultSet.getInt("user_id");
		        ...
		        %>
		            <tr>
		                ...
		                <td>
		                    <a href="updateUserList.jsp?action=retrieve&contentId=<%= contentId %>" class="edit" >
